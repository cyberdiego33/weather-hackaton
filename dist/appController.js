...
export const starterApp = function (coords) {
...
&timezone=auto`;
        ...
        const urls = { forecastUrl, bigDataUrl };
        spinner("on");
        try {
            // Calling GetWeatherFun to return state data
            const AppState = yield GetWeatherResponse(urls);
            ...
            HourlyView.DisplayHourlyData(AppState.DailyHoursData, AppState.DailyData.weekDays);
            UnitsEvents();
        }
        catch (error) {
